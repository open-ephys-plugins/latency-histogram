...
extern "C" EXPORT void getLibInfo(Plugin::LibraryInfo* info)
{
	...
	info->name = "Latency Histogram"; // <---- update
...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		//Processor name
		info->processor.name = "Latency Histogram"; //Processor name shown in the GUI
		...
		info->processor.creator = &(Plugin::createProcessor<LatencyHistogram>);
		break;
	default:
		return -1;
		break;
